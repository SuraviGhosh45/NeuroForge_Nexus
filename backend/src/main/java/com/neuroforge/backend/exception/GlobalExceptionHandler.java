...
public class GlobalExceptionHandler {
    ...
    /**
     * Shows the actual Jackson/deserialization error instead of hiding it
     * behind the generic "Malformed request body or invalid value" message.
     */
    ...
    /**
     * Role check failed (@PreAuthorize) or the caller is outside
