                                                    ...
                                                    (
                                                        ...
                                                        return (
                                                            <div
                                                                ...
                                                                className={`cursor-grab rounded-xl border bg-[#07111f] p-4 transition-all duration-200 active:cursor-grabbing ${
                                                                    isDragging
                                                                        ? "scale-[0.98] border-blue-400/40 opacity-40"
                                                                        : "border-[#e8eef8]/10 hover:border-[#e8eef8]/20 hover:bg-[#0a1625]"
                                                                }`}
                                                            >
                                                                ...
                                                                <div className="mb-3 flex items-center justify-between">
                                                                    ...
                                                                    <span className="text-[10px] uppercase tracking-wider text-[#e8eef8]/20">
                                                                        Drag to move
                                                                    </span>
