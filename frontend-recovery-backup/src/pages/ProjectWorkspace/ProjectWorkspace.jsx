...
const ProjectWorkspace = () => {
  ...
  const availableUsers = useMemo(() => {
    ...
    return users.filter((user) => {
      ...
      const assignedToAnotherProject =
        isUserAssignedToProject(user.id) && !alreadyInProject;

      return !alreadyInProject && !assignedToAnotherProject;
    });
  }, [
    users,
    project?.id,
  ...
  const openCreateTask = () => {
    if (!teamLeadMember) {
      alert(
        "Please add a Team Lead to this project before creating a task."
      );
            ...
            <div className="overflow-hidden rounded-2xl border border-[#e8eef8]/10 bg-[#0d1a2b]">
              ...
              {tasksLoading ? (
                ...
                <div className="p-10 text-center">
                  ...
                  <p className="mt-1 text-sm text-[#e8eef8]/50">
                    Create a task to start managing work in this
                    project.
                  </p>
                </div>
              ) : (
                      ...
                      {projectTasks.map(
                        (task, index) => (
                          <tr
                            ...
                            className="cursor-pointer border-b border-[#e8eef8]/10 transition hover:bg-[#e8eef8]/5 last:border-0"
                          >
                            ...
                            <td className="px-5 py-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-[#e8eef8]/70">
                                  {getTaskAssigneeName(
                                    task
                                  )}
                                </span>
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-[#e8eef8]/10 bg-[#0d1a2b] shadow-2xl shadow-black/40">
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-3 rounded-xl border border-[#e8eef8]/10 bg-[#07111f] px-4 py-3">
                  <PiUserCircle
                    size={26}
                    className="text-[#e8eef8]/40"
                  />
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#e8eef8]/40">
                      {editingTask
                        ? "Existing task assignment is preserved."
                        : "Tasks are automatically assigned to the project's Team Lead."}
                    </p>
                  </div>
                </div>
              </div>
